    ...
    <>
      ...
      <style>{`
        *, *::before, *::after { margin:0; padding:0; box-sizing:border-box; }
        ...
        .az-chip {
          font-size:clamp(12px,.95vw,16px); font-weight:700; letter-spacing:1px;
      ...
      <div className="az">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(160deg, #e0eeff 0%, rgba(0,170,255,.08) 60%, transparent 100%)",
          }}
        />
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse, rgba(0,87,255,.07) 0%, transparent 70%)",
          }}
        />
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(0,170,255,1) 0%, rgba(0,87,255,.3) 60%, transparent 100%)",
          }}
        />
        ...
        {/* Chispas */}
        <div className="az-spark az-spark-1" style={{ color: "#00AAFF" }}>
          ✦
        </div>
        <div className="az-spark az-spark-2" style={{ color: "#0057FF" }}>
          ◆
        </div>
        <div className="az-spark az-spark-3" style={{ color: "#00AAFF" }}>
          ✦
        </div>
        <div className="az-spark az-spark-4" style={{ color: "#0057FF" }}>
          ◆
        </div>

        {/* Texto rotado */}
        <div className="az-rotated-txt">
          Casa Viva · Muebles · Ofertas Especiales
        </div>
        ...
        <div className="az-layout">
          ...
          <div className="az-left">
            <div
              className="az-ring az-ring-1"
              style={{ borderColor: "#0057FF" }}
            />
            <div
              className="az-ring az-ring-2"
            ...
            <div
              ...
              style={{
                background:
                  "radial-gradient(ellipse, rgba(0,170,255,.8) 0%, rgba(0,87,255,.4) 50%, transparent 70%)",
              }}
            />
            <div
              className="az-floor"
              style={{
                background:
                  "radial-gradient(ellipse, rgba(0,87,255,.18) 0%, transparent 70%)",
              }}
            />
            ...
            <div className={`az-img-wrap ${mounted ? "on" : ""}`}>
              <img
                ...
                style={{
                  filter:
                    "drop-shadow(0 28px 56px rgba(0,87,255,.25)) drop-shadow(0 0 60px rgba(0,170,255,.15))",
                }}
              />
            </div>
            ...
            <div className="az-badges-wrapper">
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(135deg, #0057FF 0%, #00AAFF 100%)",
                }}
              >
          ...
          <div className="az-right">
            ...
            <div className="az-content idle">
              ...
              {/* Subtítulo */}
              <div
                className="az-subtitulo"
                style={{
                  background: "rgba(0,87,255,.05)",
                  borderColor: "rgba(0,87,255,.12)",
                }}
              >
              ...
              <div className="az-desc-wrap">
                <div
                  ...
                  style={{
                    background: "linear-gradient(to bottom, #00AAFF, #0057FF)",
                  }}
                />
              ...
              <div className="az-divider">
                <div
                  className="az-div-line"
                  style={{
                    background:
                      "linear-gradient(to right, rgba(0,87,255,.25), transparent)",
                  }}
                />
                <span className="az-div-gem" style={{ color: "#00AAFF" }}>
                  ◆
                </span>
                <div
                  className="az-div-line"
                  style={{
                    background:
                      "linear-gradient(to left, rgba(0,87,255,.15), transparent)",
                  }}
                />
              </div>
              ...
              <div className="az-price-wrap">
                <div className="az-price-main">
                  <div className="az-price-old-wrap">
                    ...
                    <div className="az-price-old">
                      {formatPrecio(precioLista)}
                    </div>
                  </div>
                  <div className="az-price-new" style={{ color: "#08165a" }}>
